...
import { notebookSession, createKernel, deleteKernel, executeKernel, notebookExecutionReport, } from "./jupyter.js";
    ...
    notebook
        ...
        try {
            ...
            if (owned) {
                ...
                if (!cleanedUp)
                    throw new CliError("EXECUTION_UNVERIFIED", "remote", `Execution was not verified; owned temporary kernel retained or cleanup unverified: ${id}`);
            }
            throw error;
        }
    });
